...
INSERT INTO "school"("name", "director_name", "localisation", "descritpion_courte", "description_longue", "embleme", "image") VALUES ('Poudlard', 'Godric Gryffondor, Rowena Serdaigle, Helga Poufsouffle, Salazar Serpentard (Xème siècle), Edessa Sakndenberg(XVème siècle), Elizabeth Burke et Vindictus Viridian (XVII ème siècle), Phineas Black (1847 à 1925), Armando Dippet(1925 à 1956), Albus Dumbledore (1956 à 1996), Dolores Ombrage(quelques mois en 1996), Albus Dumbledore (1996 au 30 juin 1997), Severus Rogue (1er septembre 1997 au 1er mai 1998), Minerva McGonagall (depuis 1998).', 'Pré-au-Lard en Ecosse', 'Le collège Poudlard, école de sorcellerie, est un établissement formant les jeunes sorcières et sorciers britanniques à l art et à la pratique de la magie. Il est situé en Écosse. Poudlard est un large château de sept étages supportés par la magie, avec de nombreuses tours ainsi que de très profonds donjons. Le château a été construit par Godric Gryffondor, Helga Poufsouffle, Rowena Serdaigle et Salazar Serpentard.', 'Poudlard se situe dans le Nord du Royaume-Uni, en Écosse. endroit est décrit comme montagneux et est situé à proximité d un lac. école se situe également non loin de Pré-au-Lard, un village exclusivement habité par des sorciers. Le château de Poudlard est incartable, il n’apparaît jamais sur une carte géographique. Les élèves de première année sont conduits au château en barques alors que les autres élèves y accèdent en diligences. Ces dernières remontent une longue route qui contourne le lac et qui se termine devant les grilles de fer forgé du portail de l enceinte de Poudlard. Il existe aussi huit passages secrets qui conduisent hors de l enceinte de Poudlard dont sept sont visibles depuis la Carte du Maraudeur. Le dernier fût construit en 1998 par la Salle sur Demande. Argus Rusard et les jumeaux Weasley semblent faire partie de ceux qui les connaissent. Dans le château, on retrouve : Un passage caché derrière un miroir du quatrième étage, rendu impraticable suite à un éboulement. Un passage caché sous la statue d une sorcière borgne et qui mène à la boutique Honeydukes de Pré-au-Lard. Un passage dans la salle sur demande menant à La Tête de Sanglier, une auberge de Pré-au-Lard. Dans le Parc du château, on retrouve : Un passage sous le Saule cogneur menant à la Cabane Hurlante. Le château est invisible aux yeux des Moldus, car il est protégé par un sortilège. En effet, si un Moldu s approche de Poudlard il ne verra que des ruines et poursuivra son chemin. Il est également protégé des Forces du Mal. Il est par exemple impossible pour un sorcier de transplaner dans l enceinte de Poudlard. Les mesures de sécurité furent renforcées à partir de 1996 après l annonce du retour officiel de Voldemort. Mais ces dernières n empêchèrent pas les Mangemorts de pénétrer l enceinte de l école car il existe une faille dans le système : il s agit de l Armoire à disparaître de la Salle sur Demande. Drago Malefoy en était le responsable. Le collège Poudlard a été construit au 10ème siècle, alors que les sorciers souffraient encore de persécution de la part des Moldus. Les quatre plus grands sorciers de l époque, amis de longue date, décident de s unir pour créer un lieu d épanouissement, d apprentissage pouvant également servir de refuge aux sorciers. Godric Gryffondor, Helga Poufsouffle, Rowena Serdaigle et Salazar Serpentard bâtissent leur propre école de sorcellerie, qu ils baptisent Poudlard et partent très vite à la recherche de sorciers possédant les aptitudes nécessaires pour enseigner la magie aux élèves. Mais les premières divergences apparaissent. En effet, les différences de point de vue concernant le choix des élèves et les matières enseignées se multiplient, l école est alors divisée en quatre maisons distinctes. Chaque maison prend le nom de son fondateur. Les quatre fondateurs, dont les jours sont comptés, ont l idée de donner à un chapeau ensorcelé le pouvoir de répartir chaque nouvel élève dans la maison qui lui correspond. Malgré tout, les tensions s intensifient. Salazar Serpentard refuse catégoriquement l admission d enfants nés-Moldus, personnes qui, selon lui, ne sont pas dignes d étudier la magie. À l inverse, les trois autres fondateurs s opposent et insistent pour que tous puissent se former. Serpentard quitte finalement le château, non sans raison. Aujourd hui encore, les tensions entre les maisons, en particulier entre les élèves de Gryffondor et ceux de Serpentard, sont toujours aussi vives. Poudlard sera le thêatre de moulte péripéthie, et notamment la bataille de Poudlard en mai 1998, qui verra la fin du règne de terreur de Lord Voldemort, mais aussi la dispariton de nombreuses personnes chère au coeur d Harry Potter et de ses amis, comme Albus Dumbledore, Fred Weasley, Nymphadora Thonks, Remus Lupin, ...', 'poudlard.png', 'chateau-poudlard.jpg'),
('Académie Beauxbâtons', 'Godefroy Beauxbatons(1313 à 1320), Ambelion Ballessaim(1323 à ?), Maxime Olympe(1994 à aujourd hui)', 'En France, dans les pyrénées, entre Andorre et le Perthus' , 'Académie de Beauxbâtons est un établissement formant les jeunes sorcières et sorciers Français à l art et à la pratique de la magie. Elle est située au cœur des Pyrénées, dans le Sud de la France.', 'Académie de Beauxbâtons est située dans l’Est des Pyrénées, entre Andorre et Le Perthus. Elle se trouve au cœur de la chaîne montagneuse, au sommet d une montagne décapitée communément appelée Mont Creux, dissimulée sous une, sinon la plus grande illusion du monde. Le seul moyen d y accéder est un Tunnel de Transportation à l accès très réglementé, dont la seule entrée est située dans la Gare Centrale de Transportation, au Bourg Enchanteur.  Académie a été originellement fondée en 1313, sur mes terres de St Renaud, au sein même de mon château. C était une période de crise économique importante, et la persécution de l Inquisition incitait la noblesse sorcière à faire profil bas. Le roi connaissait notre existence, et nous protégeait des rafles meurtrières du clergé, mais nous n étions pas en mesure de réclamer de l argent à la Couronne. J eus alors l idée de réunir autour de moi les plus grands précepteurs afin d enseigner toutes les subtilités de l Art aux enfants jusque-là pourris-gâtés de la Grande Noblesse. Moi, je n étais que fils puîné du Duc d Aquitaine, et à sa mort j ai hérité d un palais d été dont mon estimé frère n avait pas l usage, situé dans la commune sorcière de St Renaud-lès-Artois.
À ma mort, en 1320, ma fille unique Griselda n était pas mariée, et n était donc pas en mesure, d après les lois de l époque, de conserver le domaine. Elle a donc décidé de vendre le domaine à la Prévôté, qui en a fait une école ouverte à tous les sangs-purs. Mais surtout gratuite, l éducation n étant plus l apanage des riches. Le premier directeur, institué en 1323, répondait au nom d Ambelion Ballessaim. Un cousin éloigné de l Empereur byzantin Andronic II. En 1337 commence la plus longue guerre connue de l histoire française. La Guerre de Cent Ans, qui en aura en fait duré 116. Cette guerre opposant principalement les familles nobles françaises et anglaises pour la prétention au Trône de France, les dynasties sorcières étaient elles aussi impliquées, malgré la relative indépendance de la Prévôté. Aussi, lors de la conquête des terres d Aquitaine par les Anglais, décision fut prise de déplacer l Académie. La légende raconte qu ils auraient fait transplaner le château entier. c est tout bonnement grotesque. Et qui plus est illogique, car les plans de l Académie actuelle ont été inspirés du château de Chambord, et non du mien. l emplacement de l actuelle Académie a posé un problème plus grand. Fondée en période de guerre, la priorité était de la cacher aux Anglais, afin de préserver le savoir magique Français. Aussi, le château fut établi dans un col encaissé, au cœur même des Pyrénées, à proximité d une source naturelle. Cependant, cela suffisait peut-être à se protéger des armées ennemies, majoritairement moldue, mais pas des sorciers. Le directeur Ballessaim, un des plus grands illusionnistes de tous les temps, eut l idée, à l aide de ses pairs les plus prestigieux, et de l expert en runes Jacquemin d Éperonsang de mettre en place une dissimulation parfaite, cachant toute la vallée. Et c est ainsi qu est né le Mont Creux, une véritable montagne pour ceux qui la voient de l extérieur, mais totalement invisible pour ceux qui se trouvent en dessous. En 1420, face à la persécution croissante de l Inquisition, décision fut prise de rendre obligatoire l éducation des jeunes sorciers, peu importait la pureté de leur sang. La priorité était d éviter les incidents magiques involontaires, afin de ne pas mettre en danger la communauté magique. La meilleure défense étant l attaque, comme on le pensait à l époque, les jeunes sorciers étaient formés au combat, incité à craindre le monde moldu comme celui-ci nous craignait. Je me rappelle d ailleurs d un fait intéressant : les parents des nés-moldus étaient soumis au sortilège de mémoire. Difficile de naître sorcier dans une famille où vos parents vous considérais comme un démon. Je pense que c est ça qui a amené au fait qu on fasse si peu cas de la pureté du sang en France. On est sorcier avant tout. Mais je m égare encore. L Académie a ensuite connu une longue période de calme, jusqu en 1789. Les nombreuses attaques contre les familles nobles affectèrent beaucoup les grande lignée sorcières, et les parents commencèrent à retirer leurs enfants de l Académie, les envoyant dans les lointaines écoles, notamment à l école de Salem, jouissant à l époque d une réputation sanglante pour qui osait s en prendre aux sorciers. Je vous invite à vous renseigner sur les procès de Salem et sur Abigail Williams. Le 24 février 1792, le directeur Régis de Lauréac est tué par un Cocatris, et furent blessés les directeurs de Poudlard et de Durmstrang. Suite à cet évènement, le Tournoi des Trois Sorciers a été définitivement arrêté, après 498 ans d existence. Le 14 septembre de la même année, un convoi de diligence qui menait des élèves de Paris à l Académie est attaqué, et s en suit un violent affrontement qui causera la mort de dizaines d enfants sorciers, et de la totalité des agresseurs. Cependant, devant le danger encouru par les élèves, l Académie décida de fermer ses portes. Cette fermeture dura jusqu à 1804, date à laquelle furent fondés les Ordres, et construit les Pavillons. Jusque-là, l internat se situait dans les étages aujourd hui appelés Pavillon de Chasse. c est aussi à cette époque qu ont été créés les tunnels de Transportation. À l époque, il n y en avait qu un, reliant un bâtiment secret situé dans Paris à l Académie. En 1808 furent crées les diplômes de C.H.A.S.S.E, directement liés à la création de l Université de Chevalier-Lys, même si celle-ci a connu son véritable essor dans les années 1980, notamment avec l arrivé à la direction de Beauxbâtons d Olympe Maxime en 1982, menant à une refonte globale de l éducation sorcière Française, et au regroupement des flux d élèves par le Bourg Enchanteur.', 'beauxbatons.png', 'neant'),
('Durmstrang', 'Igor Karkaroff', 'Région de Krasnïarsk en Russie', 'L Institut Durmstrang est l une des deux écoles russes de Magie. Parmi les onze principales écoles de magie existantes, c est celle qui a la plus mauvaise réputation, connue pour ses liens avec la magie noire.', 'Château de quatre étages qui s est étendu jusqu à constituer une petite ville cramponnée à flanc de montagne, l Institut de Durmstrang est aussi appelé la Citadelle par ses résidents. Le château en lui-même est une école: mais on y trouve aussi, dans le reste de la Citadelle, des centres de recherches réservés à des professionnels, comme des Maîtres des Potions ou des experts en Magie Noire. Il n est pas rare pour les étudiants de faire des sorties. En cours de Soins aux Crétaures Magiques, certaines de ces excursions pouvaient durer jusqu à une semaine, souvent dans des milieux hostiles tels que la Sibérie. Bien que personne ne sache dans quel pays il se trouve, l institut se situe probablement dans le Grand Nord(vers la Russie ou la Scandinavie), comme le prouve l épaisse cape de fourrure de l uniforme, ainsi qu une des paroles de Viktor Krum lors du Bal de Noël :  En hiver, il ne fait pas jour longtemps. c est aussi un lieu avec des lacs et des montagnes.
Durmstrang est sûrement la plus secrète des écoles de magie. Les visiteurs se voient obligés de subir un Sortilège d Amnésie quand ils la quittent pour oublier son emplacement. l institut Durmstrang ( Angl.  Durmstrang Institute ) est l une des trois écoles de magie d Europe participant au Tournoi des Trois Sorciers en 1994 - 1995. Elle était dirigée à cette période par Igor Karkaroff. Parmi les onze principales écoles de magie existantes, c est celle qui a la plus mauvaise réputation, connue pour ses liens avec la magie noire. l institut est plus petit que Poudlard : il ne possède que quatre étages. Il est aussi beaucoup moins confortable. Il doit y faire froid car les feux ne sont allumés que pour pratiquer la magie. Cela explique pourquoi les élèves de la délégation de Durmstrang sont si émerveillés quand ils arrivent à Poudlard pour le Tournoi des Trois Sorciers.
Le parc de Durmstrang est en revanche bien plus grand, recouvrant des lacs et des montagnes. Si les élèves ne peuvent pas trop en profiter en hiver à cause de la courte durée du jour, ils aiment parcourir le domaine en été avec leurs balais volants. l institut possède également un immense navire d apparence spectrale, celui-là même que la délégation de Durmstrang utilise pour aller à Poudlard à l occasion du Tournoi des Trois Sorciers de 1994 - 1995. Le vaisseau est habituellement amarré sur un lac situé derrière l école, et les élèves s entraînent à plonger depuis le pont, comme le fait Viktor Krum pour se préparer à la Deuxième tâche. La fondatrice de l institut Durmstrang est une grande sorcière bulgare : Nérida Vulchanova. La mauvaise réputation de Durmstrang est principalement due à trois sorciers : deux directeurs et un élève. Harfang Munter, qui prit la direction de l école après la mort suspecte de Nérida Vulchanova. c est lui qui intégra les duels et la magie offensive dans le programme de l institut. Igor Karkaroff, directeur au moment du Tournoi des Trois Sorciers, ancien Mangemort qui a maintenu un climat de peur et de tensions dans l école durant la période de sa direction. De nombreux parents retirèrent d ailleurs leurs enfants de l institut, ayant peur de ses méthodes d enseignement. Gellert Grindelwald, un des mages noirs les plus célèbres et les plus meurtriers avec Voldemort du XXème siècle. Cet ancien élève est sûrement le sorcier qui a le plus nui à la réputation de l école. d après Viktor Krum, il avait dessiné sa marque sur le mur d un couloir de l école, marque qui était en réalité le symbole des Reliques de la Mort qu il avait essayé de retrouver avec Dumbledore dans leur jeunesse. Après le mandat d Igor Karkaroff, la réputation de Durmstrang s est améliorée, notamment grâce à de fameux sorciers comme Viktor Krum.', 'durmstrang.png', 'neant'),
...
('47', '2'),
('47', '9'),
>>>>>>> schoolController:server/database/import_data.sql
('47', '12');